    ...
    return (
        <div>
            <div className="room-image relative">
                ...
                <button onClick={() => navigate("/booking")} className="absolute bottom-6 right-[50%] translate-x-1/2 bg-primary hover:bg-primary-500 text-white transition font-semibold px-8 py-3 uppercase text-lg mt-10">
                    Book Now
                </button>
            </div>
